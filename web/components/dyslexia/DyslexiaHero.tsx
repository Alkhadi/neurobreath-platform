...
export function DyslexiaHero({ onScrollToSection }: DyslexiaHeroProps) {
  return (
    <div className="space-y-8">
      ...
      {/* ── Main hero content — sits directly on the dark overlay ── */}
      <div className="space-y-6 py-4">
        ...
        <div className="flex flex-wrap gap-3 [&>*]:basis-full sm:[&>*]:basis-[calc(50%-6px)] lg:[&>*]:basis-[calc(25%-9px)] [&>*]:min-w-0">
          ...
          <Button
            size="lg"
            className="w-full gap-2 bg-white/15 hover:bg-white/25 text-white border border-white/40"
        ...
        {/* Feature Highlights */}
        <div className="flex flex-wrap gap-4 pt-2 [&>*]:basis-full md:[&>*]:basis-[calc(33.333%-11px)] [&>*]:min-w-0">
          <div className="flex items-start gap-3 p-4 rounded-lg bg-white/12 border border-white/20">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white/70">Backed by NHS &amp; research from leading institutions</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 rounded-lg bg-white/12 border border-white/20">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-white text-sm">All Ages Welcome</h3>
              <p className="text-xs text-white/70">Tailored content for children, teens, and adults</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-4 rounded-lg bg-white/12 border border-white/20">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-white/70">No login required, saves privately on your device</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-white/20">
          <p className="text-xs text-white/70 italic">
            <strong className="text-white/90">Did you know?</strong> Dyslexia affects 10–15% of the population and is not related to intelligence.
      ...
      {/* Quick Navigation card — white card, dark text for contrast */}
      <Card className="border border-white/40 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm">
        <CardContent className="p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              <Button size="sm" variant="outline" onClick={() => onScrollToSection('understanding')}>
                I&apos;m an Individual
              </Button>
              <Button size="sm" variant="outline" onClick={() => onScrollToSection('guides')}>
                I&apos;m a Parent
              </Button>
              <Button size="sm" variant="outline" onClick={() => onScrollToSection('guides')}>
                I&apos;m a Teacher
