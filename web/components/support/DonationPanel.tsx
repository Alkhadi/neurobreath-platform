    ...
    <section className="py-20 px-4 bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-8">Choose an amount</h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Select a donation amount that works for you. Every contribution supports our mission to keep NeuroBreath free and accessible.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center space-y-3 text-sm text-muted-foreground">
          ...
          <p>We do not store your card details. Payments are processed securely by Stripe.</p>
          <p>
            Receipts are issued by Stripe to the email used at checkout.
          </p>
        </div>
      </div>
    </section>
