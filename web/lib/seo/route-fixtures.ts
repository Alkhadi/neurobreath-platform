...
export const routeFixtures: Record<string, string[]> = {
  ...
  "/guides/:pillar/:slug": [
    ...clusterParams.map(param => `/guides/${param.pillar}/${param.slug}`),
    "/guides/anxiety-stress/stress-general-anxiety",
    "/guides/anxiety-stress/panic-symptoms",
    "/guides/focus-adhd/focus-test-anxiety",
    "/guides/anxiety-stress/ptsd-regulation",
  ],
