...
const ROUTE_SEO_CONFIGS: Record<string, RouteSeoConfig> = {
  ...
  '/adhd': {
    ...
    keywords: [
      'ADHD focus strategies tools',
      'ADHD breathing exercises for calm',
      'ADHD attention training exercises',
      'ADHD executive function support',
      'ADHD productivity sprints recovery',
      'ADHD parent teacher support UK',
      'ADHD stress regulation techniques',
      'ADHD sleep routine support',
      'ADHD tools and focus hub',
      'ADHD wellbeing toolkit',
    ],
    path: '/adhd',
  },
  '/anxiety': {
  ...
  '/autism': {
    ...
    keywords: [
      'autism support hub UK',
      'autism sensory regulation tools',
      'autism routines visual schedule tips',
      'autism anxiety management strategies',
      'autism school support SEND',
      'autism communication supports AAC PECS',
      'autism calm breathing toolkit',
      'autism reasonable adjustments workplace',
      'autism parent teacher carer support',
      'NICE autism guidance resources',
    ],
    path: '/autism',
  },

  '/conditions/dyspraxia': {
    title: 'Dyspraxia (DCD) Support Hub | NeuroBreath',
    description:
      'Educational support for dyspraxia (DCD): coordination-friendly routines, planning prompts, movement breaks, and confidence building. Educational information only.',
    keywords: [
  ...
  '/conditions/dyscalculia': {
    title: 'Dyscalculia Support Hub | NeuroBreath',
    description:
      'Educational support for dyscalculia: number sense routines, maths anxiety support, classroom adjustments, and practical study prompts. Educational information only.',
    keywords: [
  ...
  '/conditions/dysgraphia': {
    title: 'Dysgraphia Support Hub | NeuroBreath',
    description:
      'Educational support for dysgraphia: writing routines, reduced fatigue strategies, planning prompts, and classroom adjustments. Educational information only.',
    keywords: [
  ...
  '/conditions/tourette': {
    title: 'Tourette Syndrome Support Hub | NeuroBreath',
    description:
      'Educational guidance for Tourette syndrome and tic disorders: routine support, stress reduction, and classroom adjustments. Educational information only.',
    keywords: [
  ...
  '/conditions/slcn': {
    title: 'Speech & Language (SLCN) Support Hub | NeuroBreath',
    description:
      'Educational support for speech, language and communication needs (SLCN): practical routines, visual supports, and confidence-building strategies. Educational information only.',
    keywords: [
  ...
  '/conditions/sensory-processing': {
    title: 'Sensory Processing Support Hub | NeuroBreath',
    description:
      'Educational support for sensory processing differences: sensory-friendly routines, calm corner planning, classroom adjustments, and overload recovery. Educational information only.',
    keywords: [
  ...
  '/conditions/executive-function': {
    title: 'Executive Function Support Hub | NeuroBreath',
    description:
      'Educational support for executive function challenges: planning prompts, checklists, routines, and task-starting strategies. Educational information only.',
    keywords: [
  ...
  '/conditions/auditory-processing': {
    title: 'Auditory Processing Support Hub | NeuroBreath',
    description:
      'Educational support for auditory processing difficulties: listening-friendly routines, visual backup strategies, and classroom supports to reduce fatigue. Educational information only.',
    keywords: [
  ...
  '/conditions/visual-processing': {
    title: 'Visual Processing Support Hub | NeuroBreath',
    description:
      'Educational support for visual processing difficulties: reading-friendly routines, workspace setup tips, and classroom adjustments to reduce fatigue. Educational information only.',
    keywords: [
  ...
  '/conditions/hyperlexia': {
    title: 'Hyperlexia Support Hub | NeuroBreath',
    description:
      'Educational support for hyperlexia: comprehension routines, communication supports, and balanced learning strategies. Educational information only.',
    keywords: [
  ...
  '/conditions/visual-stress': {
    title: 'Visual Stress Support Hub | NeuroBreath',
    description:
      'Educational support for visual stress: reading layout tweaks, lighting tips, visual breaks, and classroom adjustments to reduce strain. Educational information only.',
    keywords: [
  ...
  '/conditions/depression': {
    ...
    keywords: [
      'understanding depression guide',
      'depression self care breathing exercises',
      'depression behavioural activation framework',
      'depression sleep routine support',
      'depression anxiety stress regulation',
      'depression support resources UK',
      'depression signs when to seek help',
      'depression coping skills toolkit',
      'depression evidence based treatments overview',
      'depression crisis support UK US',
    ],
  ...
  '/dyslexia-reading-training': {
    ...
    keywords: [
      'dyslexia reading training exercises',
      'phonics reading practice dyslexia',
      'dyslexia reading fluency training',
      'dyslexia support tools UK',
      'reading confidence practice daily',
      'dyslexia strategies for learners',
      'dyslexia parent teacher support',
      'reading intervention practice tools',
      'dyslexia literacy support programme',
      'dyslexia reading routine exercises',
    ],
  ...
  '/tools/anxiety-tools': {
    ...
    keywords: [
      ...
      'CBT prompts for anxiety',
      'anxiety toolkit',
      'reduce worry techniques',
  ...
  '/tools/sleep-tools': {
    ...
    keywords: [
      ...
      'calm before bed breathing',
      'insomnia wind down routine',
      'sleep support tools UK',
      'night waking reset routine',
    ],
  ...
  '/tools/stress-tools': {
    ...
    keywords: [
      ...
      'reduce overwhelm tools',
      'stress management tools',
      'calming breathing timer',
      'nervous system regulation',
      'prioritisation prompts for stress',
