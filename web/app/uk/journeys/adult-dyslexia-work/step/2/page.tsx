...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/uk/journeys/adult-dyslexia-work/step/2',
    languages: {
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="flex justify-between pt-8 border-t">
        <Button asChild variant="outline">
          <Link href="/uk/journeys/adult-dyslexia-work/step/1">
            <ChevronLeft className="mr-2 h-4 w-4" />
            Previous
          </Link>
        </Button>
        <Button asChild>
          <Link href="/uk/journeys/adult-dyslexia-work/step/3">
            Next
