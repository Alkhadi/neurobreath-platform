...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/uk/journeys/adult-dyslexia-work',
    languages: {
  ...
  openGraph: {
    title: 'Dyslexia at Work Journey | NeuroBreath',
    description: 'A guided journey to navigate workplace challenges with dyslexia. Educational information only.',
    url: 'https://neurobreath.co.uk/uk/journeys/adult-dyslexia-work',
    type: 'website',
  },
};
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <Button asChild size="lg" className="flex-1">
          <Link href="/uk/journeys/adult-dyslexia-work/step/1">Start Journey</Link>
        </Button>
