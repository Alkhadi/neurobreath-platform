...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/uk/journeys/parent-autism/complete',
    languages: {
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <Button asChild variant="outline" className="w-full">
                <Link href="/uk/conditions/autism">
                  Explore
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button asChild variant="outline" className="flex-1">
          <Link href="/uk/journeys">All journeys</Link>
        </Button>
      ...
      <p className="mt-10 text-xs text-muted-foreground">
        Educational information only. Not medical advice. Consult qualified providers for personal guidance.
      </p>
    </div>
  );
}
