...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/uk/journeys/parent-autism/step/4',
    languages: {
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <article>
        ...
        <section className="prose dark:prose-invert max-w-none mb-8">
          <p>
            Support works best when it’s consistent, collaborative, and sustainable. Aim for small changes you can
            keep up over time.
          </p>
          <h3>Build your team</h3>
          <p>
            This might include school staff, clinicians, family, and other parents. Shared understanding reduces
            stress for everyone.
          </p>
          <h3>Advocacy, step-by-step</h3>
          <p>
            Keep notes on what helps and what’s hard. Clear examples make it easier to request adjustments and
            support.
          </p>
      ...
      <nav className="flex justify-between pt-8 border-t">
        ...
        <Button asChild>
          <Link href="/uk/journeys/parent-autism/complete">
            Finish
