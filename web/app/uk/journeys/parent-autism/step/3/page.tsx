...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/uk/journeys/parent-autism/step/3',
    languages: {
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <article>
        ...
        <section className="prose dark:prose-invert max-w-none mb-8">
          <p>
            Communication is more than speech. Many autistic children communicate through behaviour, gestures,
            pictures, scripts, or routines. Your goal is to reduce pressure and increase clarity.
          </p>
          <h3>Say what you mean</h3>
          <p>
            Use specific, literal wording when possible. Replace “be good” with “use a quiet voice” or “hands by your
            sides”.
          </p>
          <h3>Slow the pace</h3>
          <p>
            Some children need extra time to process language, especially when stressed. Ask one question at a time,
            then wait.
          </p>
          <h3>Validate communication attempts</h3>
          <p>
            If a child’s behaviour communicates discomfort, treat it as meaningful. Consider what the environment is
            asking of them and what support is missing.
          </p>
        </section>
      </article>
      ...
      <nav className="flex justify-between pt-8 border-t">
        ...
        <Button asChild>
          <Link href="/uk/journeys/parent-autism/step/4">
            Next
