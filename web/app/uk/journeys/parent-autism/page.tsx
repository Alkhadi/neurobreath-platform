...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/uk/journeys/parent-autism',
    languages: {
  ...
  openGraph: {
    ...
    url: 'https://neurobreath.co.uk/uk/journeys/parent-autism',
    type: 'website',
  },
};
      ...
      <Card className="bg-muted/50">
        <CardContent className="pt-6">
          <p className="text-sm text-muted-foreground">
            <strong>Educational information only.</strong> Not medical advice. This journey provides general information about autism and supportive strategies. Consult qualified healthcare providers and autism specialists for personal guidance specific to your child&apos;s needs.
          </p>
        </CardContent>
      </Card>
    </div>
