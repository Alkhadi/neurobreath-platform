...
export const metadata: Metadata = {
  title: 'Terms of Service | NeuroBreath UK',
    ...
    >
      ...
      <section>
        ...
        <ul>
          ...
          <li>We may delete your account and data (subject to our <Link href="/uk/legal/privacy">Privacy Policy</Link>)</li>
      ...
      <section>
        ...
        <p>
          These Terms, together with our <Link href="/uk/legal/privacy">Privacy Policy</Link> and{' '}
          <Link href="/uk/legal/cookies">Cookie Policy</Link>, constitute the entire agreement between you and {LEGAL_CONFIG.organizationName} 
