...
export default function UkMyAccountPage() {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Button variant="outline" onClick={() => signOut({ callbackUrl: '/uk/login' })} disabled={loading}>
              Sign out
            </Button>
            <Button asChild variant="outline" disabled={loading}>
              <Link href="/uk/change-password">Change password</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
