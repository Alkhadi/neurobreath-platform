...
import { BreathingExercise } from '@/components/stress-tools/breathing-exercise'
import { GroundingExercise } from '@/components/stress-tools/grounding-exercise'
import { StressTracker } from '@/components/stress-tools/stress-tracker'
import { MuscleRelaxation } from '@/components/stress-tools/muscle-relaxation'
import { RelaxationGame } from '@/components/stress-tools/relaxation-game'
import { ProgressTracker } from '@/components/stress-tools/progress-tracker'
import { CrisisResources } from '@/components/stress-tools/crisis-resources'
    ...
    <main className="min-h-screen">
      ...
      <section id="main-content" className="relative py-16 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Quick Stats */}
          <Card className="p-3 sm:p-5 md:p-8 bg-gradient-to-r from-teal-50 to-purple-50">
