...
export const metadata: Metadata = {
  title: 'Moving Forward - Step 3 | NeuroBreath',
  description: 'Plan for continued growth',
  alternates: {
    canonical: 'https://neurobreath.co.uk/us/journeys/new-to-adhd/step/3',
    languages: {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="flex justify-between pt-8 border-t">
        ...
        <Button asChild>
          <Link href="/us/journeys/new-to-adhd/complete">
            Next
