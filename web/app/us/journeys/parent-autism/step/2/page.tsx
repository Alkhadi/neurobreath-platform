...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/us/journeys/parent-autism/step/2',
    languages: {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        ...
        <progress className="w-full h-2" value={2} max={4} aria-label="Journey progress: step 2 of 4" />
      </div>
      ...
      <article>
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-3">
            <li className="flex gap-3"><span className="text-primary flex-shrink-0">✓</span><span>Identify sensory triggers</span></li>
            <li className="flex gap-3"><span className="text-primary flex-shrink-0">✓</span><span>Create calm spaces</span></li>
            <li className="flex gap-3"><span className="text-primary flex-shrink-0">✓</span><span>Establish predictable routines</span></li>
          </ul>
        </section>
        ...
        <section className="prose dark:prose-invert max-w-none mb-8">
          ...
          <p>
            A dedicated calm area with soft lighting, minimal noise, and comforting textures can help your child self-regulate when they feel overwhelmed. This might include cushions, a weighted blanket, or their favorite books.
          </p>
      ...
      <nav className="flex justify-between pt-8 border-t">
        <Button asChild variant="outline">
          <Link href="/us/journeys/parent-autism/step/1">
