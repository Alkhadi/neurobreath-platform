...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://neurobreath.co.uk/us/journeys/parent-autism/step/1',
    languages: {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-6">
        ...
        <progress className="w-full h-2" value={1} max={4} aria-label="Journey progress: step 1 of 4" />
      </div>
      ...
      <article>
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-3">
            <li className="flex gap-3"><span className="text-primary flex-shrink-0">✓</span><span>Understand autism as a difference, not a deficit</span></li>
            <li className="flex gap-3"><span className="text-primary flex-shrink-0">✓</span><span>Recognize your child&apos;s unique strengths</span></li>
            <li className="flex gap-3"><span className="text-primary flex-shrink-0">✓</span><span>Learn about sensory needs</span></li>
          </ul>
        </section>
      ...
      <nav className="flex justify-between pt-8 border-t">
        <Button asChild variant="outline">
          <Link href="/us/journeys/parent-autism">
