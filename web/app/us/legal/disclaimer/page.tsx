...
export const metadata: Metadata = {
  title: 'Disclaimer | NeuroBreath US',
  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          See our <Link href="/us/legal/terms">Terms of Service</Link> for full legal disclaimers and limitations of liability.
        </p>
      </section>
      ...
      <section className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg">
        ...
        <ul className="space-y-2 mb-0">
          ...
          <li>✓ <strong>Emergencies: call 911 (US) or 911 (US)</strong> — Do not rely on NeuroBreath in urgent situations</li>
