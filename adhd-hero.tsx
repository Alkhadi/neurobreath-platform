...
export function ADHDHero() {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-purple-500/10 via-blue-500/10 to-cyan-500/10 border-2 border-purple-200 p-8 md:p-12">
      {/* Background Pattern */}
      ...
      <div className="relative space-y-6">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Badge variant="outline" className="border-purple-300 bg-white/50">
            🇬🇧 UK-First Guidance
          </Badge>
          <Badge variant="outline" className="border-blue-300 bg-white/50">
            NICE NG87 • AAP • CDC
          </Badge>
        </div>
